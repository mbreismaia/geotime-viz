...
from .quicksort import quicksort, cmp
from .depth_functions import L2_depth, spatial_depth

def calculatePointwiseDepth(C, variables, pos, depth_type='L2'):
    print("Calculating pointwise depth for position:", pos)
...
def ED(C, query: QueryED):
    ...
    if variables is None or len(variables) == 0:
        print("No variables provided, using all available variables.")
        variables = list(C[0].data.keys())
